...
import {DecodersForL2, TransferToAgentOwnerMsg} from "./utils/DecodersForL2.sol";
...
contract SenderHooks is
    Initializable,
    Adminable,
    FunctionSelectorDecoder,
    DecodersForL2
{
    ...
    function beforeSendCCIPMessage(
        ...
        if (functionSelector == IStrategyManager.depositIntoStrategy.selector) {
            (
                ...
                uint256 expiry,
                // signature
            ) = decodeAgentOwnerSignature(message, message.length - 124);
